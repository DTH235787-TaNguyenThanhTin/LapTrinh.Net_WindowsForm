    ...
    public partial class Form1 : Form
    {
        ...
        private void ThucHienTinhToan()
        {
            ...
            if (rb1.Checked)
            {
                ...
                // Lưu ý: Bạn cần đảm bảo class Form2 đã tồn tại trong project
                Form2 f2 = new Form2();
                f2.canha = canh;
                f2.ShowDialog();
            }
            ...
            else if (rb2.Checked)
            {
                ...
                // Lưu ý: Bạn cần đảm bảo class Form3 đã tồn tại trong project
                Form3 f3 = new Form3();
                f3.dai = dai;
                f3.rong = rong;
                f3.ShowDialog();
            ...
            else if (rb3.Checked)
            {
                ...
                // Lưu ý: Bạn cần đảm bảo class Form4 đã tồn tại trong project
                Form4 f4 = new Form4();
                f4.bankinh = bankinh;
                f4.ShowDialog();
            }
